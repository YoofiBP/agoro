					...
					<div class="header-wrapicon2">
						...
						<div class="header-cart header-dropdown">
							<ul class="header-cart-wrapitem">
								<!--header cart items for regular pc view goes here-->
							</ul>
			...
			<div class="btn-show-menu">
				...
				<div class="header-icons-mobile">
					...
					<div class="header-wrapicon2">
						...
						<div class="header-cart header-dropdown">
							<ul class="header-cart-wrapitem">
								<!-- mobile header cart items goes here -->
							</ul>
			...
			<div class="row">
				<div class="col-md-4 p-b-30">
					<div class="hov-img-zoom">
						<img src="images/globe.jpg" alt="IMG-ABOUT">
					</div>
				</div>
				...
				<div class="col-md-8 p-b-30">
					...
					<p class="p-b-28">
						Agoro is a business entity primarily focused on providing customers with a convenient and reliable way of avoiding the cost of depreciation on the video games they buy and getting the most value for money out of unwanted video games. Our activities include an avenue to exchange unwanted (such as home-used) video games in return for money or a different video game at a marked-up but affordable price. In other words, Agoro aims to provide customers with a secure outlet to earn cash on unwanted video games which otherwise would have been kept until its value depreciates and is rendered useless.
					</p>
