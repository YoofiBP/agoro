...
<body class="animsition" onload="displayCartItems();displayCartSize();displayCartValue()">
					...
					<div class="header-wrapicon2">
						...
						<div class="header-cart header-dropdown">
							<ul class="header-cart-wrapitem">
								<!-- cart items for regular header goes here-->
							</ul>
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(images/call.jpg);">
	...
	<section class="bgwhite p-t-66 p-b-60">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 p-b-30">
					<form class="leave-comment" action="PHP/mail.php">
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="number" name="phone-number" placeholder="Phone Number">
						</div>
